...
<section class='webcams'>
  ...
  <a href='http://www.alertwildfire.org/northbay/?camera=Axis-Jackson' class='webcam' target='_blank'>
    <img src='http://api.nvseismolab.org/camera/Axis-Jackson' class='webcam--img' width='600' height='337' /><br />
    Camera 1
  </a>
  <a href='http://www.alertwildfire.org/northbay/?camera=Axis-Jackson2' class='webcam' target='_blank'>
    <img src='http://api.nvseismolab.org/camera/Axis-Jackson2' class='webcam--img' width='600' height='337' /><br />
    Camera 2
  </a>
  <b>Geyser Peak</b>
  <a href='http://www.alertwildfire.org/northbay/?camera=Axis-Geyser2' class='webcam' target='_blank'>
    <img src='http://api.nvseismolab.org/camera/Axis-Geyser2' class='webcam--img' width='600' height='337' /><br />
    West, facing Dry Creek
  </a>
  <b>Rockpile</b>
  <a href='http://www.alertwildfire.org/northbay/?camera=Axis-Rockpile' class='webcam' target='_blank'>
    <img src='http://api.nvseismolab.org/camera/Axis-Rockpile' class='webcam--img' width='600' height='337' /><br />
    Southwest facing view
  </a>
  <b>Mohrhardt Ridge</b>
  <a href='http://www.alertwildfire.org/northbay/?camera=Axis-MohrhardtRidge' class='webcam' target='_blank'>
    <img src='http://api.nvseismolab.org/camera/Axis-MohrhardtRidge1' class='webcam--img' width='600' height='337' /><br />
    East facing view
  </a>
</section>
<section>
...
<script>
  Array.from(document.getElementsByClassName('webcam--img')).forEach((image, i) => {
    setInterval(() => {
      if (image.src) {
